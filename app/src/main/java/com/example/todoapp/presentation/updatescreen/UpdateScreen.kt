package com.example.todoapp.presentation.updatescreen
...
fun UpdateScreen(
    ...
    Scaffold (
        ...
        Column(
            ...
            Icon(imageVector = Icons.Rounded.Edit, contentDescription = null, modifier =  Modifier.size(100.dp))
            Spacer(modifier = Modifier.size(16.dp))
            TextField(value = task, onValueChange = { newValue ->
            ...
            Button(onClick = {
                ...
                Text(text = "Save Task", fontSize = 16.sp)
            }
        }
    }
}